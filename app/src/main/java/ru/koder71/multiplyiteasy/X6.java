...
public class X6 extends AppCompatActivity {
    Brain brain = new Brain(6);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        know.setText(R.string.you_know_6);
        ...
        previewimg.setImageResource(R.drawable.mult_table6);
        ...
        btngood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(X6.this, GameLevels.class);
