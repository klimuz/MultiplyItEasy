...
public class X2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        table2.setContentView(R.layout.memodialog);
        ...
        btnIremember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                res.setText(String.valueOf(2 * (brain.numb.get(brain.r))));
                table2.dismiss();
            }
        ...
        //ok button start
        Button btngood = (Button) congratulation.findViewById(R.id.buttonOk);
