...
public class X9 extends AppCompatActivity {
    Brain brain = new Brain(9);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        know.setText(R.string.you_know_9);
        ...
        previewimg.setImageResource(R.drawable.mult_table9);
        ...
        btngood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(X9.this, GameLevels.class);
